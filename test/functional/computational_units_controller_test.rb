...
class ComputationalUnitsControllerTest < ActionController::TestCase
  ...
  test "should create computer" do
    assert_difference('ComputationalUnit.count') do
  ...
  test "should destroy computer" do
    assert_difference('ComputationalUnit.count', -1) do
